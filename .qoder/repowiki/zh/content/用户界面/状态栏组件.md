...
## 更新摘要
**变更内容**   
- 为状态栏组件新增了QProgressBar进度条功能，支持实时显示视频处理操作的完成百分比和详细状态消息
- 实现了进度条的自动显示/隐藏机制，在长时间操作期间提供更好的用户体验
- 增强了状态信息的可视化呈现，从纯文本升级为图形化进度条与文本描述的组合展示
- 优化了用户反馈机制，提供更直观的操作进度感知
...
**更新** 状态栏组件现已集成QProgressBar进度条功能，支持实时显示视频处理操作的完成百分比和详细状态消息，通过自动显示/隐藏机制显著提升用户体验。
